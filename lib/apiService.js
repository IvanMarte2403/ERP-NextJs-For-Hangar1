...
export async function updateOrder(order_number, repair_shop_id, updated_data) {
  ...
  // Verificar el cuerpo de la solicitud antes de modificar
  console.log("Data antes de eliminar el campo 'mobile':", updated_data);

  // Removemos el campo 'mobile' del cuerpo de la solicitud si existe y es igual a 5512606261
  if (updated_data.mobile && updated_data.mobile === "5512606261") {
      delete updated_data.mobile;
      console.log("Campo 'mobile' eliminado");
  }

  // Verificar el cuerpo de la solicitud después de modificar
  console.log("Data después de eliminar el campo 'mobile':", updated_data);
