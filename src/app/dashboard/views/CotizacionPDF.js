...
// Componente que genera el PDF de Cotización
      ...
      <Page style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={{ marginTop: 40, border: '2px solid #000', padding: '10px' }}>
            ...
            >
              <Text style={{ width: '28%', fontWeight: 'bold', textAlign: 'left' }}>
                Producto
              </Text>
              <Text style={{ width: '13%', fontWeight: 'bold', textAlign: 'left' }}>
                Costo
              </Text>
              <Text style={{ width: '13%', fontWeight: 'bold', textAlign: 'left' }}>
                Cantidad
              ...
              <Text style={{ width: '23%', fontWeight: 'bold', textAlign: 'left' }}>
                Subtotal
              </Text>
            </View>
