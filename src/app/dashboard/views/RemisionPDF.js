      ...
      <Page style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={{ flexDirection: 'row', borderTop: '1 solid black', paddingTop: 10, marginTop: 40, width: '60%' }}>
            <Text style={{ width: '70%', fontWeight: '700', fontSize: 10, paddingRight: 10 }}>
              Subtotal sin IVA:
            </Text>
          ...
          <View style={{ flexDirection: 'row', paddingTop: 10, width: '60%' }}>
            <Text style={{ width: '70%', fontWeight: '700', fontSize: 10, paddingRight: 10 }}>Descuentos:</Text>
            <Text style={[{ width: '30%' }, styles.numberTable]}>{formatCurrency(discountAmount)}</Text>
          </View>
          <View style={{ flexDirection: 'row', paddingTop: 10, width: '60%' }}>
            <Text style={{ width: '70%', fontWeight: '700', fontSize: 10, paddingRight: 10 }}>Impuestos (IVA):</Text>
            <Text style={[{ width: '30%' }, styles.numberTable]}>{formatCurrency(ivaTotal)}</Text>
          </View>
          <View style={{ flexDirection: 'row', paddingTop: 10, width: '60%' }}>
            <Text style={{ width: '70%', fontWeight: '700', fontSize: 10, paddingRight: 10 }}>Total:</Text>
